...
import com.example.danish.medicationinformationsystem.LoginDataBaseAdapter;
...
public class Sign_up extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s_login = (TextView) findViewById(R.id.link_login);
        ...
        s_login.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intentSignUP = new Intent(Sign_up.this, Login.class);
